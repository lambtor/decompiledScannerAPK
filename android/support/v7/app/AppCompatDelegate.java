...
public abstract class AppCompatDelegate {
   ...
   private static AppCompatDelegate create(Context var0, Window var1, AppCompatCallback var2) {
      ...
      if (BuildCompat.isAtLeastN()) {
         var4 = new AppCompatDelegateImplN(var0, var1, var2);
      } else if (var3 >= 23) {
         var4 = new AppCompatDelegateImplV23(var0, var1, var2);
      } else if (var3 >= 14) {
         var4 = new AppCompatDelegateImplV14(var0, var1, var2);
      } else if (var3 >= 11) {
         var4 = new AppCompatDelegateImplV11(var0, var1, var2);
      } else {
         var4 = new AppCompatDelegateImplV9(var0, var1, var2);
      }

      return (AppCompatDelegate)var4;
   }
