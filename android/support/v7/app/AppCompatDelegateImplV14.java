   ...
   private boolean updateForNightMode(int var1) {
      ...
      if ((var3 & 48) != var8) {
         if (this.shouldRecreateOnNightModeChange()) {
            ...
            Configuration var7 = new Configuration(var6);
            DisplayMetrics var9 = var5.getDisplayMetrics();
            float var2 = var7.fontScale;
            var7.uiMode = var7.uiMode & -49 | var8;
            var7.fontScale = 2.0F * var2;
            var5.updateConfiguration(var7, var9);
            var7.fontScale = var2;
            var5.updateConfiguration(var7, var9);
         }
