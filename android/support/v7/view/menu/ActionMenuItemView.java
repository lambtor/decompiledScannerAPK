...
public class ActionMenuItemView extends AppCompatTextView implements MenuView.ItemView, OnClickListener, OnLongClickListener, ActionMenuView.ActionMenuChildView {
   ...
   private boolean shouldAllowTextWithIcon() {
      ...
      int var1 = ConfigurationHelper.getScreenWidthDp(this.getResources());
      int var2 = ConfigurationHelper.getScreenHeightDp(this.getResources());
      boolean var3;
   ...
   public boolean onLongClick(View var1) {
      ...
      if (!this.hasText()) {
         ...
         if (var5 + var4 < var9.height()) {
            var11.setGravity(8388661, var2, var8[1] + var6 - var9.top);
         } else {
            var11.setGravity(81, 0, var6);
         }
