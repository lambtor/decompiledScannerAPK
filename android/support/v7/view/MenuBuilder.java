...
public class MenuBuilder implements SupportMenu {
   ...
   public final void close(boolean var1) {
      if (!this.mIsClosing) {
         ...
         while(var3.hasNext()) {
            ...
            MenuPresenter var2 = (MenuPresenter)var4.get();
            if (var2 == null) {
               this.mPresenters.remove(var4);
            } else {
               var2.onCloseMenu(this, var1);
            }
         }
      ...
      if (!this.mPresenters.isEmpty() && this.mExpandedItem == var1) {
         ...
         while(true) {
            ...
            if (var4 == null) {
               ...
               var3 = var4.collapseItemActionView(this, var1);
               var2 = var3;
               if (var3) {
                  break;
               }
      ...
      if (this.mPresenters.isEmpty()) {
         ...
         while(true) {
            ...
            if (var4 == null) {
               ...
               var3 = var4.expandItemActionView(this, var1);
               var2 = var3;
               if (var3) {
                  break;
               }
   ...
   MenuItemImpl findItemWithShortcutForKey(int var1, KeyEvent var2) {
      Object var8 = null;
      ArrayList var10 = this.mTempShortcutItemList;
      var10.clear();
      this.findItemsWithShortcutForKey(var10, var1, var2);
      MenuItemImpl var11;
      if (var10.isEmpty()) {
         ...
         if (var5 == 1) {
            ...
            while(true) {
               ...
               var11 = (MenuItemImpl)var10.get(var3);
               char var4;
               if (var7) {
               ...
               if (var4 == var9.meta[0] && (var6 & 2) == 0 || var4 == var9.meta[2] && (var6 & 2) != 0 || var7 && var4 == '\b' && var1 == 67) {
                  break;
               }
   ...
   void findItemsWithShortcutForKey(List var1, int var2, KeyEvent var3) {
      ...
      if (var3.getKeyData(var9) || var2 == 67) {
         ...
         for(int var4 = 0; var4 < var6; ++var4) {
            ...
            if ((var7 & 5) == 0 && var5 != 0 && (var5 == var9.meta[0] || var5 == var9.meta[2] || var8 && var5 == '\b' && var2 == 67) && var10.isEnabled()) {
               var1.add(var10);
            }
         }
      }
   ...
   public void restoreActionViewStates(Bundle var1) {
      if (var1 != null) {
         ...
         for(var2 = 0; var2 < var3; ++var2) {
            ...
            View var6 = MenuItemCompat.getActionView(var4);
            if (var6 != null && var6.getId() != -1) {
               var6.restoreHierarchyState(var5);
            }

            if (var4.hasSubMenu()) {
               ((SubMenuBuilder)var4.getSubMenu()).restoreActionViewStates(var1);
            }
         }
   ...
   public void setGroupVisible(int var1, boolean var2) {
      ...
      boolean var4;
      for(int var3 = 0; var3 < var6; var5 = var4) {
