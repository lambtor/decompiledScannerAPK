      ...
      if (var8 != null) {
         ...
         if (this.mMenu != null) {
            ...
            while(true) {
               ...
               MenuItemImpl var10 = (MenuItemImpl)var9.get(var4);
               var3 = var2;
               if (this.shouldIncludeItem(var2, var10)) {
                  View var7 = var8.getChildAt(var2);
                  MenuItemImpl var6;
                  if (var7 instanceof MenuView.ItemView) {
                     var6 = ((MenuView.ItemView)var7).getItemData();
                  } else {
                     var6 = null;
                  }

                  View var11 = this.getItemView(var10, var7, var8);
                  if (var10 != var6) {
         ...
         while(var3 < var8.getChildCount()) {
            if (!this.filterLeftoverView(var8, var3)) {
               ++var3;
            }
         }
      }
