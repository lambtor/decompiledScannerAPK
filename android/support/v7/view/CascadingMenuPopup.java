...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
   ...
   private int getNextMenuPosition(int var1) {
      ListView var3 = ((CascadingMenuPopup.CascadingMenuInfo)this.mShowingMenus.get(this.mShowingMenus.size() - 1)).getListView();
      int[] var4 = new int[2];
      var3.getLocationOnScreen(var4);
      Rect var2 = new Rect();
      this.mShownAnchorView.getWindowVisibleDisplayFrame(var2);
      byte var5;
      if (this.mLastPosition == 1) {
         if (var4[0] + var3.getWidth() + var1 > var2.right) {
            var5 = 0;
         } else {
            var5 = 1;
         }
   ...
   private void showMenu(@NonNull MenuBuilder var1) {
      ...
      if (var8 != null) {
         ...
         var3 = var13.window.getVerticalOffset();
         int var4 = var11[1];
         int var12;
         ...
         var9.setVerticalOffset(var3 + var4);
      } else {
         if (this.mHasXOffset) {
