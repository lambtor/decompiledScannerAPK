...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
   ...
   protected void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
      ...
      for(var2 = 0; var2 < var4; ++var2) {
         ...
         if (var10.getVisibility() != 8) {
            ...
            int var8 = var5 + var11.leftMargin;
            int var6 = var3 + var11.topMargin;
            var10.layout(var8, var6, var8 + var7, var6 + var9);
         }
      }
   ...
   protected void onMeasure(int var1, int var2) {
      ...
      var6 = ViewUtils.combineMeasuredStates(var6, ViewCompat.getMeasuredState(this.mContent));
      var5 = this.getPaddingLeft();
      var7 = this.getPaddingRight();
      var10 = Math.max(var10 + this.getPaddingTop() + this.getPaddingBottom(), this.getSuggestedMinimumHeight());
      this.setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max(var3 + var5 + var7, this.getSuggestedMinimumWidth()), var1, var6), ViewCompat.resolveSizeAndState(var10, var2, var6 << 16));
   }
