...
public final class AppCompatDrawableManager {
   ...
   private ColorStateList createButtonColorStateList(@NonNull Context var1, @ColorInt int var2, @Nullable ColorStateList var3) {
      ...
      var7[0] = ThemeUtils.DISABLED_STATE_SET;
      if (var3 != null) {
         var4 = var3.getColorForState(var7[0], 0);
      }

      var8[0] = var4;
      int var6 = 0 + 1;
      var7[var6] = ThemeUtils.PRESSED_STATE_SET;
      if (var3 == null) {
         var4 = var2;
      } else {
         var4 = var3.getColorForState(var7[var6], 0);
      }

      var8[var6] = ColorUtils.compositeColors(var5, var4);
      ++var6;
      var7[var6] = ThemeUtils.FOCUSED_STATE_SET;
      if (var3 == null) {
         var4 = var2;
      } else {
         var4 = var3.getColorForState(var7[var6], 0);
      ...
      var8[var6] = ColorUtils.compositeColors(var5, var4);
      var4 = var6 + 1;
      var7[var4] = ThemeUtils.EMPTY_STATE_SET;
      if (var3 != null) {
         var2 = var3.getColorForState(var7[var4], 0);
      }

      var8[var4] = var2;
      return new ColorStateList(var7, var8);
   }
