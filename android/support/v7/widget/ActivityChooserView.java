...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
   ...
   void updateAppearance() {
      ...
      int var2 = this.mAdapter.getActivityCount();
      int var1 = this.mAdapter.getHistorySize();
      if (var2 != 1 && (var2 <= 1 || var1 <= 0)) {
   ...
   private class ActivityChooserViewAdapter extends BaseAdapter {
      ...
      public Object getItem(int var1) {
         ...
         case 0:
            ...
            var3 = this.mDataModel.getActivity(var2);
            break;
         case 1:
            var3 = null;
            break;
      ...
      public int getItemViewType(int var1) {
         byte var2;
         if (this.mShowFooterView && var1 == this.getCount() - 1) {
            var2 = 1;
         } else {
            var2 = 0;
         }
      ...
      public View getView(int var1, View var2, ViewGroup var3) {
         ...
         case 0:
            ...
            var5.setImageDrawable(var7.loadIcon(var6));
            ((TextView)var4.findViewById(R.id.title)).setText(var7.loadLabel(var6));
      ...
      public int measureContentWidth() {
         int var6 = this.mMaxActivityCount;
