...
public class PagerTitleStrip extends ViewGroup {
   ...
   void updateTextPositions(int var1, float var2, boolean var3) {
      ...
      int var13 = this.mCurrText.getMeasuredWidth();
      ...
      var18 = Math.max(Math.max(var17 + var19, var16 + var18), var15 + var20);
      ...
      this.mCurrText.layout(var14, var6, var13, this.mCurrText.getMeasuredHeight() + var6);
      var6 = Math.min(var12, var14 - this.mScaledTextSpacing - var10);
      this.mPrevText.layout(var6, var7, var6 + var10, this.mPrevText.getMeasuredHeight() + var7);
      var6 = Math.max(var11 - var9 - var8, this.mScaledTextSpacing + var13);
