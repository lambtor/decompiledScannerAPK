   ...
   static class GestureDetectorCompatImplBase implements GestureDetectorCompat.GestureDetectorCompatImpl {
      ...
      private void init(Context var1) {
         if (var1 == null) {
            ...
            this.mDoubleTapSlopSquare = var2 * var2;
         }
      }
      ...
      public boolean onTouchEvent(MotionEvent var1) {
         ...
         float var3;
         int var8;
         for(var8 = 0; var8 < var9; var2 = var3) {
            if (var7 == var8) {
               var3 = var2;
               var2 = var4;
            } else {
               var3 = var4 + var1.getX(var8);
               var4 = var2 + var1.getY(var8);
               var2 = var3;
               var3 = var4;
            }
         ...
         case 0:
            ...
            this.mLastFocusY = var5;
            this.mDownFocusY = var5;
         ...
         case 1:
            ...
            if (this.mIsDoubleTapping) {
               ...
               label153: {
                  ...
                  var2 = VelocityTrackerCompat.getYVelocity(var15, var17);
                  var3 = VelocityTrackerCompat.getXVelocity(var15, var17);
         ...
         case 2:
            ...
            if (!this.mInLongPress) {
               ...
               var2 = this.mLastFocusY - var5;
               if (this.mIsDoubleTapping) {
                  var11 = false | this.mDoubleTapListener.onDoubleTapEvent(var1);
               } else if (this.mAlwaysInTapRegion) {
                  var7 = (int)(var3 - this.mDownFocusX);
                  var17 = (int)(var5 - this.mDownFocusY);
                  var17 = var7 * var7 + var17 * var17;
                  var12 = var13;
                  if (var17 > this.mTouchSlopSquare) {
                     var12 = this.mListener.onScroll(this.mCurrentDownEvent, var1, var4, var2);
                     this.mLastFocusX = var3;
                     this.mLastFocusY = var5;
                     this.mAlwaysInTapRegion = false;
                     this.mHandler.removeMessages(3);
                  ...
                  var11 = this.mListener.onScroll(this.mCurrentDownEvent, var1, var4, var2);
                  this.mLastFocusX = var3;
                  this.mLastFocusY = var5;
               }
            }
