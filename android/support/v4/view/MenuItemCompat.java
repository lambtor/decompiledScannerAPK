...
public final class MenuItemCompat {
   ...
   public static boolean collapseActionView(MenuItem var0) {
      ...
      if (var0 instanceof SupportMenuItem) {
         var1 = ((SupportMenuItem)var0).collapseActionView();
      } else {
         var1 = IMPL.collapseActionView(var0);
      }
   ...
   public static boolean expandActionView(MenuItem var0) {
      boolean var1;
      if (var0 instanceof SupportMenuItem) {
         var1 = ((SupportMenuItem)var0).expandActionView();
      } else {
         var1 = IMPL.expandActionView(var0);
      }
   ...
   public static ActionProvider getActionProvider(MenuItem var0) {
      ActionProvider var1;
      if (var0 instanceof SupportMenuItem) {
         var1 = ((SupportMenuItem)var0).getSupportActionProvider();
      } else {
   ...
   public static View getActionView(MenuItem var0) {
      View var1;
      if (var0 instanceof SupportMenuItem) {
         var1 = ((SupportMenuItem)var0).getActionView();
      } else {
         var1 = IMPL.getActionView(var0);
      }
   ...
   public static boolean isActionViewExpanded(MenuItem var0) {
      boolean var1;
      if (var0 instanceof SupportMenuItem) {
         var1 = ((SupportMenuItem)var0).isActionViewExpanded();
      } else {
         var1 = IMPL.isActionViewExpanded(var0);
      }
   ...
   public static MenuItem setActionProvider(MenuItem var0, ActionProvider var1) {
      if (var0 instanceof SupportMenuItem) {
         var0 = ((SupportMenuItem)var0).setSupportActionProvider(var1);
      } else {
   ...
   public static MenuItem setActionView(MenuItem var0, int var1) {
      if (var0 instanceof SupportMenuItem) {
         var0 = ((SupportMenuItem)var0).setActionView(var1);
      } else {
         var0 = IMPL.setActionView(var0, var1);
      }
   ...
   public static MenuItem setOnActionExpandListener(MenuItem var0, MenuItemCompat.OnActionExpandListener var1) {
      Object var2;
      if (var0 instanceof SupportMenuItem) {
         var2 = ((SupportMenuItem)var0).setSupportOnActionExpandListener(var1);
      } else {
         var2 = IMPL.setOnActionExpandListener(var0, var1);
      }
   ...
   static class IcsMenuVersionImpl extends MenuItemCompat.HoneycombMenuVersionImpl {
      ...
      public MenuItem setOnActionExpandListener(MenuItem var1, final MenuItemCompat.OnActionExpandListener var2) {
         if (var2 == null) {
            var1 = MenuItemCompatIcs.setOnActionExpandListener(var1, (MenuItemCompatIcs.SupportActionExpandProxy)null);
         } else {
            var1 = MenuItemCompatIcs.setOnActionExpandListener(var1, new MenuItemCompatIcs.SupportActionExpandProxy() {
