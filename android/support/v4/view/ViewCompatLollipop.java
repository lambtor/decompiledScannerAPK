...
class ViewCompatLollipop {
   ...
   static void offsetLeftAndRight(View var0, int var1) {
      ...
      if (var3 instanceof View) {
         View var4 = (View)var3;
         var5.set(var4.getLeft(), var4.getTop(), var4.getRight(), var4.getBottom());
         if (!var5.intersects(var0.getLeft(), var0.getTop(), var0.getRight(), var0.getBottom())) {
            var2 = true;
         } else {
            var2 = false;
         }
   ...
   static void offsetTopAndBottom(View var0, int var1) {
      ...
      if (var5 instanceof View) {
         View var3 = (View)var5;
         var4.set(var3.getLeft(), var3.getTop(), var3.getRight(), var3.getBottom());
         if (!var4.intersects(var0.getLeft(), var0.getTop(), var0.getRight(), var0.getBottom())) {
            var2 = true;
         } else {
            var2 = false;
         }
      ...
      if (var2 && var4.intersect(var0.getLeft(), var0.getTop(), var0.getRight(), var0.getBottom())) {
