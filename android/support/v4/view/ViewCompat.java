...
public class ViewCompat {
   ...
   static class Api24ViewCompatImpl extends ViewCompat.MarshmallowViewCompatImpl {
      public void setPointerIcon(View var1, PointerIconCompat var2) {
         ViewCompatApi24.setPointerIcon(var1, var2.getPointerIcon());
      }
   }
   ...
   static class BaseViewCompatImpl implements ViewCompat.ViewCompatImpl {
      ...
      private boolean canScrollingViewScrollHorizontally(ScrollingView var1, int var2) {
         ...
         int var3 = var1.computeHorizontalScrollRange() - var1.computeHorizontalScrollExtent();
         if (var3 == 0) {
            var5 = false;
         } else if (var2 < 0) {
            if (var4 <= 0) {
      ...
      public boolean canScrollHorizontally(View var1, int var2) {
         boolean var3;
         if (var1 instanceof ScrollingView && this.canScrollingViewScrollHorizontally((ScrollingView)var1, var2)) {
            var3 = true;
         } else {
            var3 = false;
         }
      ...
      public boolean canScrollVertically(View var1, int var2) {
         boolean var3;
         if (var1 instanceof ScrollingView && this.canScrollingViewScrollVertically((ScrollingView)var1, var2)) {
            var3 = true;
         } else {
            var3 = false;
         }
      ...
      public void dispatchFinishTemporaryDetach(View var1) {
         ...
         if (this.mDispatchFinishTemporaryDetach != null) {
            try {
               this.mDispatchFinishTemporaryDetach.invoke(var1);
      ...
      public boolean dispatchNestedFling(View var1, float var2, float var3, boolean var4) {
         if (var1 instanceof NestedScrollingChild) {
            var4 = ((NestedScrollingChild)var1).dispatchNestedFling(var2, var3, var4);
         } else {
            var4 = false;
         }
      ...
      public boolean dispatchNestedPreFling(View var1, float var2, float var3) {
         boolean var4;
         if (var1 instanceof NestedScrollingChild) {
            var4 = ((NestedScrollingChild)var1).dispatchNestedPreFling(var2, var3);
         } else {
            var4 = false;
         }
      ...
      public boolean dispatchNestedPreScroll(View var1, int var2, int var3, int[] var4, int[] var5) {
         boolean var6;
         if (var1 instanceof NestedScrollingChild) {
            var6 = ((NestedScrollingChild)var1).dispatchNestedPreScroll(var2, var3, var4, var5);
         } else {
            var6 = false;
         }
      ...
      public boolean dispatchNestedScroll(View var1, int var2, int var3, int var4, int var5, int[] var6) {
         boolean var7;
         if (var1 instanceof NestedScrollingChild) {
            var7 = ((NestedScrollingChild)var1).dispatchNestedScroll(var2, var3, var4, var5, var6);
         } else {
            var7 = false;
         }
      ...
      public void dispatchStartTemporaryDetach(View var1) {
         ...
         if (this.mDispatchStartTemporaryDetach != null) {
            try {
               this.mDispatchStartTemporaryDetach.invoke(var1);
            } catch (Exception var2) {
      ...
      public Display getDisplay(View var1) {
         return ViewCompatBase.getDisplay(var1);
      }
      ...
      public float getX(View var1) {
         return (float)var1.getLeft();
      }

      public float getY(View var1) {
         return (float)var1.getTop();
      }
      ...
      public boolean hasNestedScrollingParent(View var1) {
         boolean var2;
         if (var1 instanceof NestedScrollingChild) {
            var2 = ((NestedScrollingChild)var1).hasNestedScrollingParent();
         } else {
            var2 = false;
         }
      ...
      public boolean startNestedScroll(View var1, int var2) {
         boolean var3;
         if (var1 instanceof NestedScrollingChild) {
            var3 = ((NestedScrollingChild)var1).startNestedScroll(var2);
         } else {
            var3 = false;
         }
   ...
   static class HCViewCompatImpl extends ViewCompat.BaseViewCompatImpl {
      public int combineMeasuredStates(int var1, int var2) {
      ...
      public Matrix getMatrix(View var1) {
         return ViewCompatHC.getMatrix(var1);
      }
   ...
   static class ICSViewCompatImpl extends ViewCompat.HCViewCompatImpl {
      ...
      public boolean hasAccessibilityDelegate(View var1) {
         ...
         if (!accessibilityDelegateCheckFailed) {
            ...
            Object var6;
            try {
               var6 = mAccessibilityDelegateField.get(var1);
   ...
   static class JBViewCompatImpl extends ViewCompat.ICSMr1ViewCompatImpl {
      public AccessibilityNodeProviderCompat getAccessibilityNodeProvider(View var1) {
         ...
         AccessibilityNodeProviderCompat var3;
         if (var2 != null) {
            var3 = new AccessibilityNodeProviderCompat(var2);
         } else {
            var3 = null;
         }
      ...
      public void setBackground(View var1, Drawable var2) {
         ViewCompatJB.setBackground(var1, var2);
      }
   ...
   static class JbMr1ViewCompatImpl extends ViewCompat.JBViewCompatImpl {
      public Display getDisplay(View var1) {
         return ViewCompatJellybeanMr1.getDisplay(var1);
      }
   ...
   static class JbMr2ViewCompatImpl extends ViewCompat.JbMr1ViewCompatImpl {
      ...
      public boolean isInLayout(View var1) {
         return ViewCompatJellybeanMr2.isInLayout(var1);
      }
   ...
   static class KitKatViewCompatImpl extends ViewCompat.JbMr2ViewCompatImpl {
      ...
      public boolean isLayoutDirectionResolved(View var1) {
         return ViewCompatKitKat.isLayoutDirectionResolved(var1);
      }
   ...
   static class LollipopViewCompatImpl extends ViewCompat.KitKatViewCompatImpl {
      public WindowInsetsCompat dispatchApplyWindowInsets(View var1, WindowInsetsCompat var2) {
         return WindowInsetsCompat.wrap(ViewCompatLollipop.dispatchApplyWindowInsets(var1, WindowInsetsCompat.unwrap(var2)));
      }
      ...
      public void offsetLeftAndRight(View var1, int var2) {
         ViewCompatLollipop.offsetLeftAndRight(var1, var2);
      }

      public void offsetTopAndBottom(View var1, int var2) {
         ViewCompatLollipop.offsetTopAndBottom(var1, var2);
      }

      public WindowInsetsCompat onApplyWindowInsets(View var1, WindowInsetsCompat var2) {
         return WindowInsetsCompat.wrap(ViewCompatLollipop.onApplyWindowInsets(var1, WindowInsetsCompat.unwrap(var2)));
      }
      ...
      public void setOnApplyWindowInsetsListener(View var1, final OnApplyWindowInsetsListener var2) {
         if (var2 == null) {
            ViewCompatLollipop.setOnApplyWindowInsetsListener(var1, (ViewCompatLollipop.OnApplyWindowInsetsListenerBridge)null);
         } else {
            ViewCompatLollipop.setOnApplyWindowInsetsListener(var1, new ViewCompatLollipop.OnApplyWindowInsetsListenerBridge() {
               public Object onApplyWindowInsets(View var1, Object var2x) {
                  WindowInsetsCompat var3 = WindowInsetsCompat.wrap(var2x);
                  return WindowInsetsCompat.unwrap(var2.onApplyWindowInsets(var1, var3));
               }
            });
         }
      ...
      public void setZ(View var1, float var2) {
         ViewCompatLollipop.setZ(var1, var2);
      }
   ...
   interface ViewCompatImpl {
      ...
      boolean isInLayout(View var1);

      boolean isLaidOut(View var1);

      boolean isLayoutDirectionResolved(View var1);
      ...
      void setBackground(View var1, Drawable var2);
      ...
      void setPointerIcon(View var1, PointerIconCompat var2);
      ...
      void setZ(View var1, float var2);
