...
public class PagerTabStrip extends PagerTitleStrip {
   ...
   protected void onDraw(Canvas var1) {
      ...
      int var2 = this.mCurrText.getLeft();
      int var5 = this.mTabPadding;
      int var3 = this.mCurrText.getRight();
      ...
      var1.drawRect((float)(var2 - var5), (float)(var6 - var7), (float)(var3 + var4), (float)var6, this.mTabPaint);
   ...
   void updateTextPositions(int var1, float var2, boolean var3) {
      ...
      int var4 = var6 - this.mIndicatorHeight;
      var10.set(var8 - var5, var4, var7 + var9, var6);
      super.updateTextPositions(var1, var2, var3);
      this.mTabAlpha = (int)(Math.abs(var2 - 0.5F) * 2.0F * 255.0F);
      var10.union(this.mCurrText.getLeft() - this.mTabPadding, var4, this.mCurrText.getRight() + this.mTabPadding, var6);
