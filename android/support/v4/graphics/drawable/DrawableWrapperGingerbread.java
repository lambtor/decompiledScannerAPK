...
class DrawableWrapperGingerbread extends Drawable implements Callback, DrawableWrapper, TintAwareDrawable {
   ...
   private boolean updateTint(int[] var1) {
      ...
      if (this.isCompatTintEnabled()) {
         ColorStateList var4 = this.mState.mTint;
         Mode var5 = this.mState.mTintMode;
         if (var4 != null && var5 != null) {
            int var2 = var4.getColorForState(var1, var4.getDefaultColor());
            if (!this.mColorFilterSet || var2 != this.mCurrentColor || var5 != this.mCurrentMode) {
               this.setColorFilter(var2, var5);
               this.mCurrentColor = var2;
               this.mCurrentMode = var5;
   ...
   public ConstantState getConstantState() {
      DrawableWrapperGingerbread.DrawableWrapperState var1;
   ...
   public boolean isStateful() {
      ...
      if (this.isCompatTintEnabled() && this.mState != null) {
         var2 = this.mState.mTint;
      } else {
         var2 = null;
      }

      boolean var1;
      if ((var2 == null || !var2.isStateful()) && !this.mDrawable.isStateful()) {
         var1 = false;
      } else {
         var1 = true;
      }
