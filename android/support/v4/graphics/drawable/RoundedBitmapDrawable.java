   ...
   void updateDstRect() {
      if (this.mApplyGravity) {
         if (this.mIsCircular) {
            ...
            int var3 = Math.min(this.mDstRect.width(), this.mDstRect.height());
            var1 = Math.max(0, (this.mDstRect.width() - var3) / 2);
            int var2 = Math.max(0, (this.mDstRect.height() - var3) / 2);
            this.mDstRect.inset(var1, var2);
            this.mCornerRadius = 0.5F * (float)var3;
         } else {
