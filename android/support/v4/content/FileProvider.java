...
public class FileProvider extends ContentProvider {
   ...
   private static FileProvider.PathStrategy parsePathStrategy(Context var0, String var1) throws IOException, XmlPullParserException {
      ...
      XmlResourceParser var5 = var0.getPackageManager().resolveContentProvider(var1, 128).loadXmlMetaData(var0.getPackageManager(), "android.support.FILE_PROVIDER_PATHS");
      if (var5 == null) {
         ...
         while(true) {
            ...
            if (var2 == 2) {
               ...
               String var6 = var5.getAttributeValue((String)null, "name");
               String var7 = var5.getAttributeValue((String)null, "path");
               Object var3 = null;
               File var9;
               ...
               if (var9 != null) {
                  var4.addRoot(var6, buildPath(var9, var7));
               }
            }
         }
      }
   ...
   public Cursor query(Uri var1, String[] var2, String var3, String[] var4, String var5) {
      ...
      String[] var17 = new String[var10.length];
      ...
      for(var6 = 0; var7 < var9; ++var7) {
         String var16 = var10[var7];
         int var8;
         if ("_display_name".equals(var16)) {
            var17[var6] = "_display_name";
            var8 = var6 + 1;
            ...
            var17[var6] = "_size";
            var8 = var6 + 1;
            var11[var6] = var14.length();
            var6 = var8;
         }
      }

      String[] var15 = copyOf(var17, var6);
      Object[] var12 = copyOf(var11, var6);
