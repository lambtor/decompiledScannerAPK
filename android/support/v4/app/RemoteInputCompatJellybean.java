...
class RemoteInputCompatJellybean {
   ...
   static void addResultsToIntent(RemoteInputCompatBase.RemoteInput[] var0, Intent var1, Bundle var2) {
      ...
      for(int var3 = 0; var3 < var4; ++var3) {
         ...
         Object var6 = var2.get(var7.getResultKey());
         if (var6 instanceof CharSequence) {
            var5.putCharSequence(var7.getResultKey(), (CharSequence)var6);
         }
      }
      ...
      if (var3 == null) {
         ...
         if (var2.hasMimeType("text/vnd.android.intent")) {
            ...
            if (var2.getLabel().equals("android.remoteinput.results")) {
               var4 = (Bundle)var3.getItemAt(0).getIntent().getExtras().getParcelable("android.remoteinput.resultsData");
            }
         }
      }
