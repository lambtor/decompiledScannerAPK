...
class FragmentTransitionCompat21 {
   ...
   public static void addTransitionTargets(Object var0, Object var1, Object var2, final View var3, final FragmentTransitionCompat21.ViewRetriever var4, final View var5, FragmentTransitionCompat21.EpicenterView var6, final Map var7, final ArrayList var8, ArrayList var9, Map var10, final Map var11, ArrayList var12) {
      ...
      final Transition var15 = (Transition)var2;
      Transition var14 = (Transition)var1;
      excludeViews(var13, var15, var9, true);
      if (var0 != null || var1 != null) {
         ...
         if (var1 != null) {
            setSharedElementTargets(var14, var5, var10, var12);
            excludeViews(var13, var14, var12, true);
            excludeViews(var15, var14, var12, true);
         }
         ...
         var3.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
            public boolean onPreDraw() {
                  ...
                  if (var1 != null) {
                     if (!var7.isEmpty()) {
                        ...
                        while(var2.hasNext()) {
                           ...
                           if (var5x != null) {
                              var5x.setTransitionName((String)var3x.getKey());
                           }
                        }
                     }
               ...
               FragmentTransitionCompat21.excludeViews(var15, var13, var8, true);
               return true;
            }
         });
      ...
      if (var14 != null) {
         var0.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
            public boolean onPreDraw() {
               ...
               while(var4.hasNext()) {
                  Entry var3x = (Entry)var4.next();
                  ((View)var3x.getValue()).setTransitionName((String)var3x.getKey());
               }
   ...
   private static Rect getBoundsOnScreen(View var0) {
      ...
      var2.set(var1[0], var1[1], var1[0] + var0.getWidth(), var1[1] + var0.getHeight());
      return var2;
   }
   ...
   public static void setEpicenter(Object var0, View var1) {
      ((Transition)var0).setEpicenterCallback(new EpicenterCallback(getBoundsOnScreen(var1)) {
         // $FF: synthetic field
