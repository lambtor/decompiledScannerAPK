   ...
   public static boolean areNotificationsEnabled(Context var0) {
      ...
      label37: {
         try {
            ...
            var1 = ((Integer)var12.getMethod("checkOpNoThrow", Integer.TYPE, Integer.TYPE, String.class).invoke(var3, ((Integer)var12.getDeclaredField("OP_POST_NOTIFICATION").get(Integer.class)).intValue(), var1, var11)).intValue();
            break label37;
