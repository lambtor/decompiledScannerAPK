...
class NotificationCompatApi21 {
   ...
   static Bundle getBundleForUnreadConversation(NotificationCompatBase.UnreadConversation var0) {
      ...
      if (var0 == null) {
         ...
         Parcelable[] var5 = new Parcelable[var0.getMessages().length];

         for(int var1 = 0; var1 < var5.length; ++var1) {
            var4 = new Bundle();
            var4.putString("text", var0.getMessages()[var1]);
            var4.putString("author", var2);
            var5[var1] = var4;
         }

         var3.putParcelableArray("messages", var5);
   ...
   static NotificationCompatBase.UnreadConversation getUnreadConversationFromBundle(Bundle var0, NotificationCompatBase.Factory var1, RemoteInputCompatBase.Factory var2) {
      ...
      if (var0 == null) {
         ...
         PendingIntent var10 = (PendingIntent)var0.getParcelable("on_reply");
         android.app.RemoteInput var13 = (android.app.RemoteInput)var0.getParcelable("remote_input");
         String[] var12 = var0.getStringArray("participants");
         var7 = (NotificationCompatBase.UnreadConversation)var8;
         if (var12 != null) {
            var7 = (NotificationCompatBase.UnreadConversation)var8;
            if (var12.length == 1) {
               ...
               var7 = var1.build(var6, var15, var10, var11, var12, var0.getLong("timestamp"));
            }
         }
      }
