   ...
   private static Bitmap createDrawableBitmap(Drawable var0) {
      ...
      if (var2 > 0 && var3 > 0) {
         ...
         if (var0 instanceof BitmapDrawable && var1 == 1.0F) {
            ...
            int var6 = var10.top;
            var3 = var10.right;
            int var5 = var10.bottom;
            var0.setBounds(0, 0, var2, var7);
            var0.draw(var9);
            var0.setBounds(var4, var6, var3, var5);
            var11 = var8;
         }
      } else {
         var11 = null;
         ...
         if (var9 != null && var8 == null) {
            ...
            if (var16 != null) {
               ...
               if (var7.getScaleType() == ScaleType.MATRIX) {
                  Matrix var11 = var7.getImageMatrix();
                  float[] var14 = new float[9];
                  var11.getValues(var14);
                  var13.putFloatArray("sharedElement:snapshot:imageMatrix", var14);
                  var10 = var13;
               }
