...
public class AppLaunchChecker {
   ...
   public static void onActivityCreate(Activity var0) {
      ...
      if (!var1.getBoolean("startedFromLauncher", false)) {
         ...
         if (var2 != null && "android.intent.action.MAIN".equals(var2.getAction()) && (var2.hasCategory("android.intent.category.LAUNCHER") || var2.hasCategory("android.intent.category.LEANBACK_LAUNCHER"))) {
