...
public abstract class MediaBrowserServiceCompat extends Service {
            ...
            void onResultSent(List var1, int var2x) {
               ...
               if (var1 != null) {
                  ...
                  while(true) {
                     ...
                     MediaBrowserCompat.MediaItem var7 = (MediaBrowserCompat.MediaItem)var6.next();
      ...
      public void setSessionToken(final MediaSessionCompat.Token var1) {
         MediaBrowserServiceCompat.this.mHandler.post(new Runnable() {
            public void run() {
               ...
               while(var1x.hasNext()) {
                  MediaBrowserServiceCompat.ConnectionRecord var3 = (MediaBrowserServiceCompat.ConnectionRecord)var1x.next();

                  try {
                     var3.callbacks.onConnect(var3.root.getRootId(), var1, var3.root.getExtras());
                  } catch (RemoteException var4) {
                     Log.w("MBServiceCompat", "Connection for " + var3.pkg + " is no longer valid.");
                     var1x.remove();
                  }
               }
   ...
   private class ServiceBinderImpl {
      ...
      public void registerCallbacks(final MediaBrowserServiceCompat.ServiceCallbacks var1, final Bundle var2) {
         MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
            public void run() {
               IBinder var2x = var1.asBinder();
               MediaBrowserServiceCompat.this.mConnections.remove(var2x);
               MediaBrowserServiceCompat.ConnectionRecord var1x = MediaBrowserServiceCompat.this.new ConnectionRecord();
               var1x.callbacks = var1;
               var1x.rootHints = var2;
               MediaBrowserServiceCompat.this.mConnections.put(var2x, var1x);
            }
         });
      }
