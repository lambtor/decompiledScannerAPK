   ...
   public MediaDescriptionCompat getDescription() {
      ...
      if (this.mDescription != null) {
         ...
         if (!TextUtils.isEmpty(var10)) {
            ...
            int var3;
            for(var1 = 0; var2 < var7.length && var1 < PREFERRED_DESCRIPTION_ORDER.length; var2 = var3) {
   ...
   public static final class Builder {
      ...
      public Builder(MediaMetadataCompat var1, int var2) {
         ...
         while(true) {
            ...
            } while(!var3.equals("android.media.metadata.ART") && !var3.equals("android.media.metadata.ALBUM_ART"));

            this.putBitmap(var3, var6.copy(var6.getConfig(), false));
         }
      }
