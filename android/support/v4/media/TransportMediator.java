...
public class TransportMediator extends TransportController {
   ...
   private TransportMediator(Activity var1, View var2, TransportPerformer var3) {
      ...
      this.mKeyEventCallback = new Callback() {
         public boolean onKeyDown(int var1, KeyEvent var2) {
            boolean var3;
            if (TransportMediator.isMediaKey(var1)) {
               var3 = TransportMediator.this.mCallbacks.onMediaButtonDown(var1, var2);
            } else {
               var3 = false;
            }
         ...
         public boolean onKeyUp(int var1, KeyEvent var2) {
            boolean var3;
            if (TransportMediator.isMediaKey(var1)) {
               var3 = TransportMediator.this.mCallbacks.onMediaButtonUp(var1, var2);
            } else {
               var3 = false;
            }
   ...
   private TransportStateListener[] getListeners() {
      TransportStateListener[] var1;
      if (this.mListeners.size() <= 0) {
         var1 = null;
      } else {
         var1 = new TransportStateListener[this.mListeners.size()];
   ...
   public Object getRemoteControlClient() {
      Object var1;
      if (this.mController != null) {
         var1 = this.mController.getRemoteControlClient();
      } else {
         var1 = null;
      }
