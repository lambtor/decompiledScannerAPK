...
public interface IMediaSession extends IInterface {
   ...
   public abstract static class Stub extends Binder implements IMediaSession {
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         ...
         case 2:
            ...
            var10 = this.sendMediaButton(var24);
            var3.writeNoException();
            var13 = var5;
            if (var10) {
               var13 = 1;
   ...
   private static class Proxy implements IMediaSession {
      ...
      public long getFlags() throws RemoteException {
         ...
         try {
            var5.writeInterfaceToken("android.support.v4.media.session.IMediaSession");
            this.mRemote.transact(9, var5, var3, 0);
            var3.readException();
            var1 = var3.readLong();
         } finally {
            var3.recycle();
      ...
      public int getRatingType() throws RemoteException {
         ...
         try {
            var2.writeInterfaceToken("android.support.v4.media.session.IMediaSession");
            this.mRemote.transact(32, var2, var4, 0);
            var4.readException();
            var1 = var4.readInt();
         } finally {
            var4.recycle();
      ...
      public void pause() throws RemoteException {
         ...
         try {
            var2.writeInterfaceToken("android.support.v4.media.session.IMediaSession");
            this.mRemote.transact(18, var2, var1, 0);
            var1.readException();
         } finally {
            var1.recycle();
            var2.recycle();
      ...
      public void prepare() throws RemoteException {
         ...
         try {
            var3.writeInterfaceToken("android.support.v4.media.session.IMediaSession");
            this.mRemote.transact(33, var3, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var3.recycle();
      ...
      public void previous() throws RemoteException {
         ...
         try {
            var2.writeInterfaceToken("android.support.v4.media.session.IMediaSession");
            this.mRemote.transact(21, var2, var1, 0);
            var1.readException();
         } finally {
            var1.recycle();
            var2.recycle();
      ...
      public void stop() throws RemoteException {
         ...
         try {
            var2.writeInterfaceToken("android.support.v4.media.session.IMediaSession");
            this.mRemote.transact(19, var2, var1, 0);
            var1.readException();
         } finally {
            var1.recycle();
            var2.recycle();
