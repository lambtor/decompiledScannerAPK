...
public final class LinkifyCompat {
   ...
   private static final void pruneOverlaps(ArrayList var0, Spannable var1) {
      ...
      while(true) {
         while(var3 < var4 - 1) {
            LinkifyCompat.LinkSpec var8 = (LinkifyCompat.LinkSpec)var0.get(var3);
            var5 = (LinkifyCompat.LinkSpec)var0.get(var3 + 1);
            var2 = -1;
            if (var8.start <= var5.start && var8.end > var5.start) {
               if (var5.end <= var8.end) {
                  var2 = var3 + 1;
               } else if (var8.end - var8.start > var5.end - var5.start) {
                  var2 = var3 + 1;
               } else if (var8.end - var8.start < var5.end - var5.start) {
                  var2 = var3;
               }
